...
//    [self addNavigationRightButton:(NavigationRightBtnTypeText) image:nil text:@"取消选中" andTextColor:kMainBlueColor];
...
- (void)setRightItem{
    ...
    rightItem.frame= CGRectMake(SelfView_W-70, 0, 60, 25);
    ...
    [rightItem setTitleColor:kMainBlueColor forState:UIControlStateNormal];
...
-(UICollectionView *)ado_collectionView
{
    if (!_ado_collectionView) {
        ...
        _ado_collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, SelfView_W, SelfView_H - TabBar_H ) collectionViewLayout:layout];//- kApplicationSingle.kStatusBarAndNavigationBarHeight
...
-(void)finishColorAndTextChange:(NSInteger)choosePhotoCount
{
    ...
    if ([_finishBtn.titleLabel.text isEqualToString:finishStr]&&!_chooseArray.count) {
        ...
        [_finishBtn setTitleColor:kMainBlueColor forState:UIControlStateNormal];
    }
}
