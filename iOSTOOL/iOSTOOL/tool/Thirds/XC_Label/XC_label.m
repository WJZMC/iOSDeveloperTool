...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.xc_label.font = kFontNomal(13);
    
    BOOL isHave = [self.selectedArr containsObject:indexPath];
    
    if (isHave) {
        
         cell.cellbackColor = kMainBlueColor;
         cell.xc_label.textColor = [UIColor whiteColor];
    }else{
        
         cell.cellbackColor = self.opetionsColor?self.opetionsColor:[UIColor whiteColor];
         cell.xc_label.textColor = [UIColor lightGrayColor];
    }
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section{
    ...
    if (section == 0) {
       ...
       return  CGSizeMake(header_width, 0);
    }
